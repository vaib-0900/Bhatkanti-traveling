...
const AddTourschedulesModal = ({ show, onClose, onUserAdded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await http.post("/tourschedule/store", form);

      console.log("TOURSCHEDULE SUCCESS:", res.data);
      ...
      console.log("TOURSCHEDULE ERROR:", error);
      ...
      if (error.response?.data?.errors) {
        ...
        setErrors({
          general:
            ...
            "Something went wrong while adding tour schedule",
        });
      }
