...
const AddTourschedulesModal = ({ show, onClose, onUserAdded }) => {
    const { http } = AuthUser()
    ...
    const handleSubmit = async (e) => {
        ...
        await http.post('/tourschedule/store', form)
            .then(() => {
                setSubmitting(false)
                setForm(initialForm)
            ...
            .catch((err) => {
                setSubmitting(false)
                console.log(err)
                console.log('Error in adding tourschedule')
                ...
                <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title fw-bold">Add Tour Schedule</h5>
                        ...
                        <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-check form-switch mt-2">
                                            <input
                                                ...
                                                onChange={handleChange}
                                            />
                                            <label className="form-check-label" htmlFor="is_cancelled">
                                                Cancelled
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div className="modal-footer">
                                ...
                                <button
                                    ...
                                    disabled={submitting}
                                >
                                    {submitting ? 'Saving...' : 'Save Tour Schedule'}
                                </button>
                            </div>
                        </form>
                    </div>
...
export default AddTourschedulesModal
