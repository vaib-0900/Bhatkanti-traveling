...
const EditPaymentsModal = ({ show, onClose, payment, onPaymentUpdated }) => {
    const { http } = AuthUser()
    ...
    const handleSubmit = async (e) => {
        ...
        await http.put(`/payment/update/${payment.id}`, form)
            .then(() => {
                setSubmitting(false)
                ...
                <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title fw-bold">Edit Payment</h5>
