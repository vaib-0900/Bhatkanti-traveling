...
const AddNotificationsModal = ({ show, onClose, onnotificationsAdded }) => {
    const { http } = AuthUser()
    ...
    const handleSubmit = async (e) => {
        ...
        await http.post('/notification/store', form)
            .then(() => {
                setSubmitting(false)
                setForm(initialForm)
                if (onnotificationsAdded) onnotificationsAdded()
                onClose()
            })
            .catch((err) => {
                setSubmitting(false)
                ...
                <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title fw-bold">Add Notification</h5>
